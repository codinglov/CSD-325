...
dice total to an even (cho) or odd (han) number. If the player gets a 2 or 7 on a dice roll, they get a 10 mon bonus
''')
...
while True:  # Main game loop.
    ...
    while True:
        ...
        if bet != 'CHO' and bet != 'HAN':
            print('Please enter either "CHO" or "HAN". LMM:')
            continue
        else:
            break
